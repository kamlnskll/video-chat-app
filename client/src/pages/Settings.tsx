...
const Settings = () => {
  ...
  return (
    <div>
      ...
      <div className='bg-white dark:bg-slate-800 dark:text-white first-letter:border-gray-50 shadow-sm border rounded-lg w-[500px] h-[450px] mx-auto mt-28 pt-4 relative'>
        <div
          className={
            window
              ? `absolute w-full h-full bg-white dark:bg-slate-800`
              : `hidden`
          }
        >
          <h1
            className='cursor-pointer absolute top-0 left-4 hover:bg-gray-100 hover:rounded-full px-1 dark:hover:bg-slate-700'
            onClick={() => setWindow('')}
          >
            <Back />
          </h1>
        ...
        <div className='text-center mt-4 rounded-lg text-sm'>
          <h1
            className='border w-1/3 mx-auto rounded-lg p-1 bg-gray-200 cursor-pointer dark:bg-slate-600 dark:hover:bg-slate-700 '
            onClick={() => setWindow('Edit Account')}
          >
            Edit Account
          </h1>
          <h1
            className='border w-1/3 mx-auto mt-2 rounded-lg p-1 bg-gray-200 cursor-pointer dark:bg-slate-600 dark:hover:bg-slate-700'
