...
const JoinCall = ({isOpen, toggleFunction}: Props) => {
  ...
  return (
  <>
  {isOpen ? <div className='bg-white border rounded-xl w-[400px] h-[150px]'>
  <h1 className='text-center mt-4'>Please enter the call ID</h1>
  <div className='w-5/6 mx-auto'>
  <input placeholder='Call Id' className='border w-full pl-2 mt-4' value={callId} onChange={(e) => setCallId(e.target.value)}/>
